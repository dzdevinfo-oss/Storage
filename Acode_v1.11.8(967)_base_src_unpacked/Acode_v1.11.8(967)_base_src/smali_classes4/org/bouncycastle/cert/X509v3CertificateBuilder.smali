...
.method public build(Lorg/bouncycastle/operator/ContentSigner;)Lorg/bouncycastle/cert/X509CertificateHolder;
    ...
    iget-object v1, p0, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->tbsGen:Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;

    invoke-virtual {v1, v0}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->setSignature(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)V
    ...
    invoke-virtual {v1, v2}, Lorg/bouncycastle/asn1/x509/ExtensionsGenerator;->getExtension(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncycastle/asn1/x509/Extension;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->generateTBSCertificate()Lorg/bouncycastle/asn1/x509/TBSCertificate;
    ...
    invoke-static {v2, v3, v4}, Lorg/bouncycastle/cert/DeltaCertificateTool;->trimDeltaCertificateDescriptor(Lorg/bouncycastle/asn1/x509/DeltaCertificateDescriptor;Lorg/bouncycastle/asn1/x509/TBSCertificate;Lorg/bouncycastle/asn1/x509/Extensions;)Lorg/bouncycastle/asn1/x509/DeltaCertificateDescriptor;
    ...
    invoke-virtual {v3, v4, v1, v2}, Lorg/bouncycastle/asn1/x509/ExtensionsGenerator;->replaceExtension(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;ZLorg/bouncycastle/asn1/ASN1Encodable;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v1, v2}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->setExtensions(Lorg/bouncycastle/asn1/x509/Extensions;)V

    :cond_1
    :try_start_1
    iget-object v1, p0, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->tbsGen:Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;

    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->generateTBSCertificate()Lorg/bouncycastle/asn1/x509/TBSCertificate;

    move-result-object v1

    invoke-static {p1, v1}, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->generateSig(Lorg/bouncycastle/operator/ContentSigner;Lorg/bouncycastle/asn1/ASN1Object;)[B

    move-result-object p1

    new-instance v2, Lorg/bouncycastle/cert/X509CertificateHolder;

    invoke-static {v1, v0, p1}, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->generateStructure(Lorg/bouncycastle/asn1/x509/TBSCertificate;Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;[B)Lorg/bouncycastle/asn1/x509/Certificate;

    move-result-object p1

    invoke-direct {v2, p1}, Lorg/bouncycastle/cert/X509CertificateHolder;-><init>(Lorg/bouncycastle/asn1/x509/Certificate;)V
    :try_end_1
...
.method public build(Lorg/bouncycastle/operator/ContentSigner;ZLorg/bouncycastle/operator/ContentSigner;)Lorg/bouncycastle/cert/X509CertificateHolder;
    ...
    invoke-virtual {v2, v3, p2, v1}, Lorg/bouncycastle/asn1/x509/ExtensionsGenerator;->addExtension(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;ZLorg/bouncycastle/asn1/ASN1Encodable;)V
    :try_end_0
    ...
    iget-object v2, p0, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->tbsGen:Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;

    invoke-virtual {v2, v0}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->setSignature(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)V
    ...
    invoke-virtual {v2, v3}, Lorg/bouncycastle/asn1/x509/ExtensionsGenerator;->addExtensions(Lorg/bouncycastle/asn1/x509/Extensions;)V
    ...
    invoke-static {v3}, Lorg/bouncycastle/asn1/x509/DeltaCertificateDescriptor;->getInstance(Ljava/lang/Object;)Lorg/bouncycastle/asn1/x509/DeltaCertificateDescriptor;
    ...
    invoke-static {v3, v4, v2}, Lorg/bouncycastle/cert/DeltaCertificateTool;->trimDeltaCertificateDescriptor(Lorg/bouncycastle/asn1/x509/DeltaCertificateDescriptor;Lorg/bouncycastle/asn1/x509/TBSCertificate;Lorg/bouncycastle/asn1/x509/Extensions;)Lorg/bouncycastle/asn1/x509/DeltaCertificateDescriptor;
    ...
    invoke-virtual {v1}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->generatePreTBSCertificate()Lorg/bouncycastle/asn1/ASN1Sequence;

    move-result-object v1

    invoke-static {p3, v1}, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->generateSig(Lorg/bouncycastle/operator/ContentSigner;Lorg/bouncycastle/asn1/ASN1Object;)[B
    ...
    invoke-direct {v3, p3}, Lorg/bouncycastle/asn1/DERBitString;-><init>([B)V

    invoke-virtual {v1, v2, p2, v3}, Lorg/bouncycastle/asn1/x509/ExtensionsGenerator;->addExtension(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;ZLorg/bouncycastle/asn1/ASN1Encodable;)V

    iget-object p2, p0, Lorg/bouncycastle/cert/X509v3CertificateBuilder;->tbsGen:Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;

    invoke-virtual {p2, v0}, Lorg/bouncycastle/asn1/x509/V3TBSCertificateGenerator;->setSignature(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)V
