...
.method public getRecipients(Lorg/bouncycastle/cms/RecipientId;)Ljava/util/Collection;
    ...
    check-cast v0, Lorg/bouncycastle/cms/PKIXRecipientId;

    invoke-virtual {v0}, Lorg/bouncycastle/cms/PKIXRecipientId;->getIssuer()Lorg/bouncycastle/asn1/x500/X500Name;

    move-result-object v1

    invoke-virtual {v0}, Lorg/bouncycastle/cms/PKIXRecipientId;->getSubjectKeyIdentifier()[B
    ...
    new-instance v4, Lorg/bouncycastle/cms/PKIXRecipientId;

    invoke-virtual {v0}, Lorg/bouncycastle/cms/PKIXRecipientId;->getType()I

    move-result v5

    invoke-virtual {v0}, Lorg/bouncycastle/cms/PKIXRecipientId;->getSerialNumber()Ljava/math/BigInteger;

    move-result-object v6

    const/4 v7, 0x0

    invoke-direct {v4, v5, v1, v6, v7}, Lorg/bouncycastle/cms/PKIXRecipientId;-><init>(ILorg/bouncycastle/asn1/x500/X500Name;Ljava/math/BigInteger;[B)V
    ...
    new-instance v3, Lorg/bouncycastle/cms/PKIXRecipientId;

    invoke-virtual {v0}, Lorg/bouncycastle/cms/PKIXRecipientId;->getType()I

    move-result v0

    invoke-direct {v3, v0, v7, v7, v2}, Lorg/bouncycastle/cms/PKIXRecipientId;-><init>(ILorg/bouncycastle/asn1/x500/X500Name;Ljava/math/BigInteger;[B)V
