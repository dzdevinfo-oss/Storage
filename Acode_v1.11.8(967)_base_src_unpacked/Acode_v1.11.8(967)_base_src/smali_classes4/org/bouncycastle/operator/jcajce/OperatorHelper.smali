...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/operator/jcajce/OperatorHelper$OAEPParamsValue;,
...
.field private static final oaepParamsMap:Ljava/util/Map;
...
.method static constructor <clinit>()V
    ...
    sput-object v5, Lorg/bouncycastle/operator/jcajce/OperatorHelper;->oaepParamsMap:Ljava/util/Map;

    new-instance v6, Lorg/bouncycastle/operator/DefaultSignatureNameFinder;

    invoke-direct {v6}, Lorg/bouncycastle/operator/DefaultSignatureNameFinder;-><init>()V

    sput-object v6, Lorg/bouncycastle/operator/jcajce/OperatorHelper;->sigFinder:Lorg/bouncycastle/operator/DefaultSignatureNameFinder;

    sget-object v6, Lorg/bouncycastle/asn1/oiw/OIWObjectIdentifiers;->idSHA1:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    sget-object v6, Lorg/bouncycastle/asn1/teletrust/TeleTrusTObjectIdentifiers;->ripemd160:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v5, v0, v1}, Lorg/bouncycastle/operator/jcajce/OperatorHelper$OAEPParamsValue;->add(Ljava/util/Map;Ljava/lang/String;Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)V
...
.method createAsymmetricWrapper(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;Ljava/util/Map;)Ljavax/crypto/Cipher;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/operator/OperatorCreationException;
    ...
    sget-object v2, Lorg/bouncycastle/operator/jcajce/OperatorHelper;->oaepParamsMap:Ljava/util/Map;

    invoke-interface {v2, v1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lorg/bouncycastle/operator/jcajce/OperatorHelper$OAEPParamsValue;

    if-eqz v1, :cond_2

    invoke-virtual {p1}, Lorg/bouncycastle/asn1/pkcs/RSAESOAEPparams;->withDefaultPSource()Lorg/bouncycastle/asn1/pkcs/RSAESOAEPparams;

    move-result-object p1

    invoke-virtual {v1, p1}, Lorg/bouncycastle/operator/jcajce/OperatorHelper$OAEPParamsValue;->matches(Lorg/bouncycastle/asn1/pkcs/RSAESOAEPparams;)Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-virtual {v1}, Lorg/bouncycastle/operator/jcajce/OperatorHelper$OAEPParamsValue;->getCipherName()Ljava/lang/String;
    ...
    :cond_2
    :try_start_2
    iget-object p1, p0, Lorg/bouncycastle/operator/jcajce/OperatorHelper;->helper:Lorg/bouncycastle/jcajce/util/JcaJceHelper;

    invoke-interface {p1, p2}, Lorg/bouncycastle/jcajce/util/JcaJceHelper;->createCipher(Ljava/lang/String;)Ljavax/crypto/Cipher;
    ...
    const-string p2, "\'algorithmID\' cannot be null"
