          ...
          <div className="flex items-center justify-between px-1 mt-1">
            <div className="flex items-center gap-1">
              <button 
                ...
                className={`p-3 rounded-full transition-all android-ripple ${discoveryEnabled ? 'text-white bg-[var(--accent)] shadow-md hover:bg-[var(--accent-dark)]' : 'text-[var(--text-muted)] hover:text-[var(--accent)] hover:bg-[var(--surface-hover)]'}`}
              ...
              <button 
                ...
                className={`p-3 rounded-full transition-all android-ripple ${adaptiveThinking ? 'text-white bg-[var(--accent)] shadow-md hover:bg-[var(--accent-dark)]' : 'text-[var(--text-muted)] hover:text-[var(--accent)] hover:bg-[var(--surface-hover)]'}`}
              ...
              <button 
                ...
                className={`p-3 rounded-full transition-all android-ripple ${generateMemory ? 'text-white bg-[var(--accent)] shadow-md hover:bg-[var(--accent-dark)]' : 'text-[var(--text-muted)] hover:text-[var(--accent)] hover:bg-[var(--surface-hover)]'}`}
