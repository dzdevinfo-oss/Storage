...
import { Menu, Plus, ChevronDown, FileOutput, Trash2, FileType, FileText, FileJson, Terminal as TerminalIcon } from 'lucide-react';
...
export const ChatHeader: React.FC<ChatHeaderProps> = ({
  ...
  return (
    <header className="flex items-center justify-between px-2 pt-3 pb-1.5 shrink-0 bg-transparent z-20 top-0 relative">
      ...
      <div className="flex items-center">
        <button 
          ...
          className="p-3 text-[var(--text-primary)] rounded-full transition-colors android-ripple" 
          aria-label="Open Termux Terminal"
        >
