...
export const PromptLibraryModal: React.FC<PromptLibraryModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
      ...
      >
        <div className="p-5 pb-4 flex justify-between items-center z-10 relative border-b border-[var(--border-drawer)] bg-[var(--bg-main)]">
          <div className="flex items-center gap-1">
            ...
            <nav className="flex items-center font-medium tracking-tight mt-0.5">
              ...
              <span className="text-[22px] text-[var(--text-primary)]">Prompt Library</span>
            </nav>
          </div>
